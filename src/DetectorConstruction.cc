...
{
  fBoxX = 12.0*m; //World size X
  fBoxY = 12.0*m; //World size Y
  fBoxZ = 12.0*m;  //World size Z
...
G4VPhysicalVolume* DetectorConstruction::ConstructVolumes()
{
  ...
  G4double labX = 10*m;     //inner X dimension of the lab
  G4double labY = 10*m;       //inner Y dimension of the lab
  G4double labZ = 10*m;     //inner Z dimension of the lab


  ar40 = MaterialWithSingleIsotope("Ar40", "Ar40", 1.3954*g/cm3, 18,40);
  ar36 = MaterialWithSingleIsotope("Ar36", "Ar36", 1.3954*g/cm3, 18,36);
  //create a box of liquid argon
  G4Box* argonS = new G4Box("Interior",
			       labX/2,
			       labY/2,
			       labZ/2);

  argonL = new G4LogicalVolume(argonS,
			       ar36,
			       "Argon");
  argonP = new G4PVPlacement(0,
			     G4ThreeVector(),
			     argonL,
			     "Argon",
			     worldL,
